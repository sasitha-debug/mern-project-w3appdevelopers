      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-2">App Developers</p>
          </motion.div>
          ...
          >
            We provide top-tier IT services using the latest technologies to deliver affordable and innovative solutions. 
            Whether launching a new business or optimizing an existing one, we accelerate growth through software development, 
            app creation, graphic design, digital marketing, and data analytics.
          </motion.p>
